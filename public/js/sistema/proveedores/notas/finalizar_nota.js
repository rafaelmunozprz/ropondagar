$(document).ready(function () {
    ...
    function continuar_nota(nota, id_nota, pagada = false) {
        let STORE = new Storage('venta_proveedor');
            ...
            setTimeout(() => {
                ...
                modal.find(".cuerpo_modal").html(`
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-6 my-2">
                                            <a target="_blank" href="${RUTA}sistema/proveedor/pdf/facturaticket/${id_nota}"class="btn btn-info btn-border btn-round  btn-block"> <span class="btn-label"> <i class="fa fa-print"></i></span>Print Ticket</a>
                                        </div>
                                        <div class="col-md-6 col-6 my-2">
                ...
                $("#send_mail").on('click', function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: RUTA + "back/proveedores/nota",
                        data: `opcion=enviar_nota_email&id_nota=${id_nota}`,
                        dataType: "JSON",
                        error: function (xhr, status) {
                            console.log(xhr.responseText);
                            toastr['error']('Error de respuesta del servidor');
