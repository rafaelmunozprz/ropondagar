...
foreach ($productos as $i => $producto) {
    ...
    $cuerpo_productos .= '^FO40,' . ($fila_ac) . '^A0,25^FD' . '   x  $ ' . number_format($producto['precio'], 2) . '^FS';
    $cuerpo_productos .= '^FO200,' . ($fila_ac) . '^A0,25^FD' . $producto['modelo'] . '^FS';
...
$ZPL_FORMAT = '^XA
	...
	^FO10,790^A0,25^FD      Fecha: ' . $mes . ' ' . $hoy  . '^FS
