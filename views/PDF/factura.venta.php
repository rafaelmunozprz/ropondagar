...
$cliente = ($cliente ? $cliente : array(
    ...
    "direccion" => array(
        0 => [
            ...
            "numero_externo" => 'Sin número',
            "numero_interno" => "Sin número interno",
            "colonia" => "Sin colonia",
            "ciudad" => "Sin ciudad",
            "estado" => "Sin Estado",
...
$tbl = '<br><h1 style="text-align:center">Nota de venta Ropón Dagar</h1><br>
    <table cellspacing="0" cellpadding="1">
        ...
        <tr>
            <td style="width: 55px;"><h4>Teléfono: </h4></td>
            <td style="width: 65%;">' . ($cliente ? $cliente['telefono'] : '000-000-00-00') . '</td>
            <td></td>
        </tr>
        <tr>
            <td style="width: 55px;"><h4>Dirección: </h4></td>
            <td>' . ($direccion ? $direccion['direccion'].', '.$direccion['numero_externo'].' '.$direccion['numero_interno'].', COLONIA: '.$direccion['colonia'].', CP: '.$direccion['cp']: "") . '</td>
            <td></td>
        </tr>
        <tr>
