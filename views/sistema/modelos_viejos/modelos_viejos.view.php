...
<body>
        ...
        <div class="main-panel">
            <div class="content">
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-1">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white fw-bold pb-0">Modelos Viejos</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <form id="form_search_modelo_viejo" method="GET">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <button class="btn btn-default btn-border" type="button"><i class="fas fa-qrcode"></i></button>
                                        </div>
                                        <input type="text" class="form-control" name="buscador_modelo_viejo" placeholder="Buscar todos los modelos" aria-label="" aria-describedby="basic-addon1" autocomplete="off">
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="row justify-content-between align-items-stretch" id="contenedor_modelos_viejos"></div>
                    <div class="row">
    ...
    <script src="<?php echo $RUTA; ?>js/sistema/modelos_viejos/modelos_viejos.js"></script>
    <script src="<?php echo $RUTA; ?>js/sistema/modelos_viejos/mostrar_modelos_viejos.js"></script>
    <script src="<?php echo $RUTA; ?>js/sistema/modelos_viejos/nuevo_modelo_viejo.js"></script>
