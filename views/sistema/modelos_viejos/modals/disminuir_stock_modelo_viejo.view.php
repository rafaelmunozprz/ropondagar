<div class="modal fade" id="vista_disminuir_stock_modelo_viejo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" id="disminuir_stock_ll">
                    <div class="row">
                        <div class="col-12 text-justify text-md-left px-0">
                            <div class="form-group mb-0 py-0">
                                <label for="nombre" class="mb-0">Cantidad</label>
                                <input type="number" min="1" step="1" class="form-control" name="disminuir_stock" placeholder="Stock" required>
                            </div>
