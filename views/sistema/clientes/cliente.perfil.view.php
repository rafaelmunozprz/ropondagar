...
<body>
    <div class="wrapper">
        <?php $TEMPLATE->nav_bar_admin('clientes', 'clientes'); ?>
        ...
        <div class="main-panel">
                            ...
                            <div class="card card-profile px-0">
                                <div class="card-header bg-primary">
                                    <div class="profile-picture">
                                        <div class="avatar avatar-online">
                                            <input type="hidden" id="id_cliente" value="<?php echo $id_cliente; ?>" hidden="hidden" class="hidden d-none" autocomplete="off">

                                            <span class="avatar-title rounded-circle border border-white bg-primary"><?php echo $cliente['razon_social'][0]; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body mb-0 pb-0">
                                    <div class="user-profile text-center" id="perfil_principal">
                                        <div class="name"> <?php echo $cliente['razon_social']; ?>.</div>
                                        <div class="job">Persona: <?php echo $cliente['tipo_persona']; ?></div>
                                        <div class="contact">Venta: <?php echo $cliente['tipo_cliente']; ?></div>
                                        <div class="tel"> <a href="tel:<?php echo $cliente['telefono']; ?>"><?php echo $cliente['telefono']; ?></a></div>
                                    </div>
                                </div>
                                <div class="card-body my-0 py-0 direccion_cont text-center">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col text-right">
                                            <a href="#" class="h4 text-info " id="mostrar_cambios_cliente"> <u> <i class="fas fa-user-cog mr-2"></i> Modificar cliente</u></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="row user-stats text-center">
                                        <div class="col">
                                            <div class="number"><?php echo $cliente['estado']; ?></div>
                                            <div class="title">
                                                <a class="btn btn-primary btn-border btn-round py-0" id="update_user" data-status="<?php echo $cliente['estado']; ?>">
                                                    <i class="<?php echo ($cliente['estado'] == 'activo' ? 'fas fa-toggle-on text-success' : 'fas fa-toggle-off text-warning'); ?> fa-2x"></i>
                                                </a>
                                            </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="title">
                                                <a id="reset_password" class="btn btn-primary btn-border btn-round py-1 px-1">NA/N</a>
                                            </div>
                                        </div>
                                        <div class="col">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center bg-white my-2" id="paginacion_p">
                        <div class="col-md-6 col-8  ">
                            <a class="btn btn-secondary btn-border btn-round btn-block notas_clientes">Mostrar más <i class="fas fa-arrow-circle-down mx-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php include '../views/sistema/proveedores/modal/impresiones.modal.php'; ?>
            <?php include '../views/sistema/proveedores/modal/opciones.modal.php'; ?>
    ...
    <script src="<?php echo $RUTA; ?>js/sistema/clientes/editar_cliente.js"></script>
    <script src="<?php echo $RUTA; ?>js/sistema/ventas_clientes/cuerpo_notas.js"></script>
    <script src="<?php echo $RUTA; ?>js/sistema/ventas_clientes/mostrar_notas.js"></script>
    <script src="<?php echo $RUTA; ?>js/sistema/ventas_clientes/pagar_nota.js"></script>
    <script src="<?php echo $RUTA; ?>js/sistema/ventas_clientes/estadisticas.js"></script>
