<div class="modal fade" id="modal_new_proveedor" tabindex="-1" role="dialog" aria-labelledby="modal_new_proveedor_label" aria-hidden="true" style="z-index: 10001;">
    <div class="modal-dialog modal-lg modal_new_proveedores" role="document">
        <div class="modal-content cuerpo">
            <div class="modal-header">
                <h5 class="modal-title mx-auto" id="modal_new_proveedor_label">Registro de Proveedores</h5>
                <button type="button" class="close mr-2" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body form_carrito">
                <form action="nuevo_proveedor" id="registrar_proveedor" method="post">
