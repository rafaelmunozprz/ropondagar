...
<body>
                                    ...
                                    <div class="col-12 px-sm-1 px-0">
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                ...
                                                Solamente es una vista de la nota si quieres hacer algun pago a las notas es necesario hacerlo en el listado de notas o en el perfil del proveedor.
                                                <p>Recuerda que puedes agregar todos los productos al stock haciendo click en el siguiente botón</p>
                                            </div>
                                            <div class="card-footer text-muted py-2 px-1">
                                                <a class="btn bg-primary text-white mx-3 py-1" title="Agregar al stock" id="enviar_todo_stock">
                                                    <span> Agregar a stock</span>
    ...
    <script src="<?php echo $RUTA; ?>js/sistema/proveedores/inventario/invoice.js"></script>
    <script src="<?php echo $RUTA; ?>js/sistema/proveedores/inventario/vista_nota.js"></script>
